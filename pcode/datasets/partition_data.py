...
class DataPartitioner(object):
    ...
    def _create_indices(self, indices):
        if self.partition_type == "origin":
            ...
            list_of_indices, client_class_info = build_non_iid_by_dirichlet(
                random_state=random_state_partition,
            ...
            self.client_class_info = client_class_info
...
def build_non_iid_by_dirichlet(
    ...
    return idx_batch, client_class_info
...
if __name__ == "__main__":
    ...
    partitions, _ = build_non_iid_by_dirichlet(
